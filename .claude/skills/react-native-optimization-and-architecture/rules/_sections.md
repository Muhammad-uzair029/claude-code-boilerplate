...
**Impact:** HIGH  
**Description:** Modular monolith layout — `src/modules/<feature>/` for
self-contained features, `src/shared/` for cross-module primitives, `src/app/`
for routes and composition only. Business logic in hooks; screens stay
presentational.
...
## 13. Third-Party Dependencies (imports)
